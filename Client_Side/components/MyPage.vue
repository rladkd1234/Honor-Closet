    ...
    <div id="mypage">
        <div id="content">
            ...
            <ul>
                ...
                <!-- 주문내역은 @click.native="getPurchaseList" 이부분 수정하면 됨. -->
                <li class="menuline"><router-link to="/purchaselist" tag="div" class="menu"
                    @mouseover.native="menu2 = true"
                    @mouseleave.native="menu2 = false"
                    @click.native="getPurchaseServer({userId : getUserId})"
...
import {mapActions, mapGetters, mapMutations} from 'vuex'
    export default {
        ...
        methods : {
            ...mapActions(['getCartServer', 'getLikeServer', 'getPurchaseServer']),
